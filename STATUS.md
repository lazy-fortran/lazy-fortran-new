...
M3 — twenty-one bounded semantic-oracle slices promoted; full Core 0 remains
pending
...
review. M3 is now open through twenty-one bounded contracts, including C717,
C720, C722, C724, C726, C731, C732 and C733.
...
- M3 is `OPEN` through twenty-one promoted bounded slices, including C717,
  C720, C722, C724, C726, C731, C732 and C733; full Core 0 remains open.
  D0126 selects
...
The current blocker is witness closure outside the bounded slices: 150 rows
(86 disputed and 64 unwitnessed) remain after promoted-contract rows are
separated, as regenerated by R000520. C735@1 is now first; R000520 is the
post-C733 reconciliation. A
