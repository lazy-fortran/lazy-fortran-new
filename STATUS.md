...
- M3 is `OPEN` through `T-M3-c1106-semantic-oracle`. D0124 and D0125 select
  ...
  `tests/e2e/run-m3-c1106.sh .cache/runs/E0175/R000473`; its mechanical replay
...
oracle; central replay `R000473` passes and focused review is pending.
...
Verifier: `tests/e2e/run-m3-c1106.sh .cache/runs/E0175/R000473` from clean
...
central C1106 replay passes in R000473; the remaining blocker is focused
...
against the frozen R000473 packet, followed by final promotion reconciliation:
...
central commit `bdb8717`. The M3 C1106 central replay `R000473` is `PASS`;
