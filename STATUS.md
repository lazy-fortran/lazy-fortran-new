...
Current fixture: `T-M3-core0-next-bounded-property-selection-after-c735`.
...
disputed and 64 unwitnessed), with C743@1 first. Full M3 remains open; do not
resume E0172 or start broad semantic work.

## Active task

ID: `T-M3-core0-next-bounded-property-selection-after-c735` — select one
bounded source-backed property after C735 promotion.

Verifier: recompute the exact twenty-two-contract promoted partition from the
pinned E0181 witnesses JSONL; confirm 149 residual rows, 85 disputed, 64
unwitnessed and C743@1 first. Inspect that row's pinned canonical source and
existing StandardIR shape, then select exactly one bounded property with no
model execution or semantic promotion. Do not broaden the semantic lane or
start general parsing.
...
separated, as regenerated by R000529 and the post-C735 partition below. C743@1
is now first. A
...
Select one bounded source-backed property from the post-C735 residual. The
retained 149-row witness ledger remains open; do not restart E0172 or broaden
semantic work. C735 is promoted only as the typed uniqueness oracle recorded by
E0202/R000527 and reviewed by R000528. The next selection must remain smaller
than general parsing or semantic analysis. No broader semantic work is
authorized.
...
`T-M3-core0-next-bounded-property-selection-after-c735`.
```
