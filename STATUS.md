...
R000486 and focused review R000487 pass, so fifteen bounded slices are
promoted. The audit residual
...
The current blocker is witness closure outside the bounded slices: 156 rows
(89 disputed and 67 unwitnessed) remain after promoted-contract rows are
separated, as regenerated by the next-selection verifier below. A green
bounded slice alone does not close full M3. The C717 and C720 replays, durable
