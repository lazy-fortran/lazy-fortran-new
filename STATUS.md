...
M3 — twenty-three bounded semantic-oracle slices promoted; full Core 0 remains
pending
...
review. M3 is now open through twenty-three bounded contracts, including C717,
C720, C722, C724, C726, C731, C732, C733, C735 and C743.
...
- M3 is `OPEN` through twenty-three promoted bounded slices, including C717,
  C720, C722, C724, C726, C731, C732, C733, C735 and C743; full Core 0 remains open.
  D0126 selects
...
Current fixture: `T-M3-core0-next-bounded-property-selection-after-c743`.
...
ID: `T-M3-core0-next-bounded-property-selection-after-c743` — select one
bounded source-backed property after C743 promotion.

Verifier: recompute the exact twenty-three-contract promoted partition from
the pinned E0181 witnesses JSONL; confirm 148 residual rows, 85 disputed, 63
unwitnessed and C744@1 first; inspect that row's pinned canonical source and
existing StandardIR shape; select exactly one source-backed bounded property
with no model execution or semantic promotion. Do not broaden the semantic
lane or start general parsing.
...
The current blocker is witness closure outside the bounded slices: 148 rows
(85 disputed and 63 unwitnessed) remain after promoted-contract rows are
separated, as regenerated by R000534 and the post-C743 partition below.
C744@1 is now first. A
...
Select one bounded source-backed property from the post-C743 residual. The
retained 148-row witness ledger remains open; do not restart E0172 or broaden
semantic work. C743 is promoted only as the typed uniqueness oracle recorded
by E0204/R000531 and reviewed by R000532. The next selection must remain
smaller than general parsing or semantic analysis.

The current post-C743 partition is regenerated with:
