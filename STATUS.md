...
C720, C722, C724 and C726. C731 is the current verified-but-unreviewed slice.
...
- M3 is `OPEN` through eighteen promoted bounded slices, including C717, C720,
  C722, C724 and C726; the C731 replay is verified and awaits focused review.
  ...
  Clean replay R000509 passes with 2 `ACCEPTED`, 2 `REJECTED`, 8
  `UNRESOLVED`, twelve mutation failures and zero model calls or semantic
  promotions. C731 remains bounded evidence pending focused review; full M3
  remains open.
...
existing StandardIR R721. Replay R000509 verifies the bounded typed-state
oracle; focused review is pending. Full M3 remains open; do not resume E0172
...
review R000491 pass. C724 replay R000494 and focused review R000495 pass, and
  ...
  passes and awaits focused review; eighteen bounded slices remain promoted.
  The audit residual
...
property by R000507. A
  ...
  claims; the C731 replay passes pending focused review. No retained-ledger
...
Complete the focused C731 review and, if it passes, promote only the bounded
oracle. The retained 153-row witness ledger remains open; do not restart E0172
or broaden semantic work. Only after that promotion should the controller
recompute the residual partition and select one source-backed property.
