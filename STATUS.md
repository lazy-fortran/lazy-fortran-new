...
- M3 is `OPEN` through the promoted C1106 slice and active task
  ...
  mechanical gate is
  `tests/e2e/run-m3-c702.sh .cache/runs/E0176/R000003`; corrected ledger
  candidate `R000005` binds the same passing replay to the normative PDF hash.
...
colon semantic oracle; central replay `R000003` passes and corrected ledger
candidate `R000005` is awaiting focused review. C1106 remains promoted and
...
Verifier: `tests/e2e/run-m3-c702.sh .cache/runs/E0176/R000003` from clean
...
R000003 passes and its corrected ledger candidate is R000005; the focused
review is the current blocker. Full M3/Core 0 remains open and requires later
