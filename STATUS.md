...
- M3 is `OPEN` through the promoted C1106, C702, C601, C603 and C721 slices.
  ...
  authoritative replay R000050 passes and focused review is pending.
...
Active candidate: `T-M3-c719-semantic-oracle` — replay `R000050` passes;
...
checkouts. The authoritative replay is R000050; it includes the pinned
...
R000050 is green and focused review is pending. The nine promoted slices and
...
Run two focused independent reviews of C719 against R000050. If both pass,
...
review `R000015` are `PASS`; the C601 central replay `R000003` and focused
  ...
  R000050 and awaits focused review; nine bounded slices are promoted and
