...
Current fixture: `T-M3-c744-derived-type-end-type-name-relation-oracle`.
...
ID: `T-M3-c744-derived-type-end-type-name-relation-oracle` — implement the
bounded C744 source-backed verifier/oracle selected by E0205/R000537.

Verifier: from a clean checkout, run `tests/e2e/run-m3-c744.sh --fresh`. The
...
C744@1 is now source-bound, but its bounded deterministic verifier/oracle is
...
Implement the C744 contract selected by D0150/E0205: typed END TYPE name
presence, name relation and context fields, a deterministic three-outcome
oracle, positive and negative neighbours, unresolved controls, mutation
controls and replayable trace. The exact central command is
`tests/e2e/run-m3-c744.sh --fresh`. This is a bounded oracle delivery only; it
does not restart E0172, parse general Fortran or close full M3.
