...
storage, sequence, STOP and PRINT waves are integrated; its central replay passes 30 routes
...
and `PRINT *, 7, 8` waves are integrated. The two-item route preserves
R1212/R1215/R1217 provenance, emits typed MIR
`const/output/const/output/return`, rejects three mutation controls, and
produces exact stdout `7` plus newline followed by `8` plus newline under qemu.
The next parallel boundary is a three-item output list; this does not parse
...
| fortfront-new | lazy-fortran/fortfront-new | `85265912e44ae85e0316a312e0e2fc1a269bc9c1` | frontend | generated program-unit-v2 CLI, bounded assignment sequences, STOP 7 and PRINT one-/two-item routes; `fo` passes |
| ffc-new | lazy-fortran/ffc-new | `2ab3e7a52341bb2374956811ee13bb5a08ecb0df` | compiler driver and middle end | generated v2 assignment envelopes, sequence MIR routes, and typed STOP/PRINT one-/two-item MIR routes; `fo` passes |
| fortback-new | lazy-fortran/fortback-new | `eb393399c2cc9b0cbea2c43b3ae8ae141f9cd636` | backend | generated stack-slot/sequence routes, STOP 7 termination, and exact PRINT one-/two-item RISC-V Linux output policies; `fo` passes |
