...
The current blocker is witness closure outside the bounded slices: 152 rows
(88 disputed and 64 unwitnessed) remain after promoted-contract rows are
separated, as regenerated by R000512. C732@1 is now first; R000512 is the
post-C731 reconciliation. A
...
unwitnessed rows, with C732@1 first. The controller must select one
