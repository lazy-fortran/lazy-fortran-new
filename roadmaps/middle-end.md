...
The first target-independent function boundary and a witness-bounded canonical
MIR SX handoff are integrated and remain additive. The bounded frontend result
lowers into that boundary. A backend worker may consume a pinned MIR fixture
before the full middle end exists, but it must not redefine MIR in the backend
