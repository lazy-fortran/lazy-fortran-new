...
object writing, and stream-unit output are integrated and preserve source
identity through their encoding fixtures. ISA ingestion, semantics, encoders,
decoders, ABI metadata and object writing do not wait for the frontend.
