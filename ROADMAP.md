...
proven. No semantic or model work resumes until that target lane closes.
...
- [ ] E0150: finish generic parser-target role factoring with lineage,
      selected parser reachability and independent language-preservation
      witnesses. The current data-reference family is a candidate, not an
