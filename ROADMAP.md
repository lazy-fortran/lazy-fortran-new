...
`frontend-ast-v2/execution-part-6`. The central replay passes 30 routes;
...
parallel wave extends this same source-backed output list to three integer
items. Keep all existing generated policy lanes and their independent negative
controls. This remains bounded I/O, not general format processing or full
Fortran semantics.
