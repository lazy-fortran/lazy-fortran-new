...
through one bounded source-backed semantic contract, while broad semantic and
model work remains closed until that contract is reviewed and a later contract
...
name. E0175 binds that relation to the existing StandardIR rows R1102, R1103
and R1106 and to canonical-text lines 8731--8734. The exact source hashes,
...
The first active M3 contract is the deterministic C1106 slice described above
and in D0124/E0175. The M3 model lane remains frozen by D0084, E0172 remains
