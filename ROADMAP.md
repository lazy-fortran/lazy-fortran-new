...
proven. The final opt-in generic role-family mechanism is now accepted in
`standard-new` `9cd164d45a29ef325ea0751496ddd2c2d5b41fc4`, with complete
source-record witnesses, mutation controls, a bounded language oracle and all
four export paths; E0150/R000306 records Luna's approval. This closes the
mechanism experiment, not the full-profile M2 gate: the selected export still
needs a source-expression identity witness and real positive/negative corpus.
No semantic or model work resumes until the source-validity lane closes.
