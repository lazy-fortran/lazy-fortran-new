...
* The all-root grammar is a closure validator. A production parser export needs
  an explicit selected-root mode and deterministic reachability pruning.
...
The current selected replay is E0147/R000022, generated by
`standard-new` `c955c23bd57a078c8fceb30de1df101280b25e2c`, and compared in the
new E0149/R000005 replay. The analysis script now detects a selected-root
...
`expected_difference` in M022--M024. The current concrete projection gap is
the mutually recursive R918/R915 normalization: the generated selected Bison
file has four unreachable normalized nonterminals and seven useless rules
after the source lineage has been substituted into the designator path. This
is evidence for generic normalized-target reachability pruning and a
language/provenance witness, not permission to delete source rules or to add a
Fortran-specific exception.
