...
ledger="${E0130_RUNS:-$root/research/runs/2026-08.jsonl}"
outdir="${1:-$root/.cache/runs/E0130/R000001}"
...
' "$ledger" >/dev/null || die 'accepted fortfront-new run with a clean fo gate is missing'
