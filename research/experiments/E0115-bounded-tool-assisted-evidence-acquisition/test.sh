...
python3 -m py_compile "$exp/run-local-tools.py" "$exp/test-local-tools.py" "$exp/plot.py" "$exp/plot-convergence.py" "$exp/retry-incomplete.py" "$exp/assemble-results.py"
