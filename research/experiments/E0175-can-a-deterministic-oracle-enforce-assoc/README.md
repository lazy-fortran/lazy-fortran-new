...
`known`, `present` and nullable `value` fields. The mechanical oracle compares
present names using the ASCII Fortran case-equivalence rule and returns
...
three StandardIR source rows, evaluates the six fixed witnesses, runs three
