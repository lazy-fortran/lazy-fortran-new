...
def main() -> int:
    ...
    findings = [
        ...
        {"id": "F002", "class": "defect", "scope": "R724, R773, R774, R775",
         "finding": "U+2019 is emitted as RIGHT_SINGLE_QUOTE instead of ASCII character-literal delimiter '.",
        ...
        {"id": "F003", "class": "projection_gap", "scope": "duplicate-occurrences.tsv",
         "finding": "Identical source occurrences remain repeated target alternatives without merged lineage.",
         "evidence": "duplicate-occurrences.tsv"},
        {"id": "F004", "class": "projection_gap", "scope": "selected-root replay",
         "finding": "The default all-roots Bison wrapper is a closure validator, not a parser entry point.",
        ...
        {"id": "F005", "class": "projection_gap", "scope": "selected-root replay",
         "finding": "Normalized helper productions remain emitted but unreachable from r_program.",
