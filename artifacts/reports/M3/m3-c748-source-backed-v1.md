...
Bounded-slice status: `PENDING REVIEW`; C748 is eligible for promotion only
as this bounded oracle leaf after focused independent review. Full M3 remains
`OPEN`. This artifact does not claim a Fortran parser, name resolver or
