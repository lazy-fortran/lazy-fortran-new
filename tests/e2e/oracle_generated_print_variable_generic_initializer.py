#!/usr/bin/env python3
"""Independent oracle for generated in-range variable initializer transport."""
...
def main() -> int:
    if len(sys.argv) != 5:
        raise OracleFailure("usage: oracle_generated_print_variable_generic_initializer.py AST MIR ELF SOURCE")
    ...
    print("generic variable initializer oracle PASS")
    return 0
...
if __name__ == "__main__":
    try:
        ...
        print(f"generic variable initializer oracle failure: {error}", file=sys.stderr)
        raise SystemExit(1)
