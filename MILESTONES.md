...
The next controller task selects one bounded property after C743. Its current
partition is 148 residual rows (85 `disputed`, 63 `unwitnessed`) with C744@1
first, regenerated by:
